...
$script_templates = [
	'tmpl-elementor-template-library-header-actions' => (
		...
		'<div id="elementor-template-library-header-import" class="elementor-templates-modal__header__item">
			<i class="eicon-upload-circle-o" aria-hidden="true" title="' . esc_attr__( 'Import Template', 'elementor' ) . '"></i>
			<span class="elementor-screen-only">' . esc_html__( 'Import Template', 'elementor' ) . '</span>
		</div>' : ''
	) . '
		<div id="elementor-template-library-header-sync" class="elementor-templates-modal__header__item">
			<i class="eicon-sync" aria-hidden="true" title="' . esc_attr__( 'Sync Library', 'elementor' ) . '"></i>
			<span class="elementor-screen-only">' . esc_html__( 'Sync Library', 'elementor' ) . '</span>
		</div>
		<div id="elementor-template-library-header-save" class="elementor-templates-modal__header__item">
			<i class="eicon-save-o" aria-hidden="true" title="' . esc_attr__( 'Save', 'elementor' ) . '"></i>
			<span class="elementor-screen-only">' . esc_html__( 'Save', 'elementor' ) . '</span>
		</div>',
	'tmpl-elementor-template-library-header-menu' => '
		<# jQuery.each( tabs, ( tab, args ) => { #><div class="elementor-component-tab elementor-template-library-menu-item" data-tab="{{{ tab }}}">{{{ args.title }}}</div><# } ); #>
	',
	'tmpl-elementor-template-library-header-preview' => '
		<div id="elementor-template-library-header-preview-insert-wrapper" class="elementor-templates-modal__header__item">{{{ elementor.templates.layout.getTemplateActionButton( obj ) }}}</div>
	',
	'tmpl-elementor-template-library-header-back' => '
		<i class="eicon-" aria-hidden="true"></i><span>' . esc_html__( 'Back to Library', 'elementor' ) . '</span>
	',
	'tmpl-elementor-template-library-loading' => '
		<div class="elementor-loader-wrapper"><div class="elementor-loader"><div class="elementor-loader-boxes"><div class="elementor-loader-box"></div><div class="elementor-loader-box"></div><div class="elementor-loader-box"></div><div class="elementor-loader-box"></div></div></div><div class="elementor-loading-title">' . esc_html__( 'Loading', 'elementor' ) . '</div></div>
	',
	'tmpl-elementor-template-library-templates' => '
		...
		<div id="elementor-template-library-toolbar">
				...
				<div id="elementor-template-library-filter-toolbar-remote" class="elementor-template-library-filter-toolbar">
					<# if ( \'page\' === activeType ) { #>
						<div id="elementor-template-library-order">
							...
							<label for="elementor-template-library-order-new" class="elementor-template-library-order-label">' . esc_html__( 'New', 'elementor' ) . '</label>
							...
							<label for="elementor-template-library-order-trend" class="elementor-template-library-order-label">' . esc_html__( 'Trend', 'elementor' ) . '</label>
							...
							<label for="elementor-template-library-order-popular" class="elementor-template-library-order-label">' . esc_html__( 'Popular', 'elementor' ) . '</label>
						</div>
					...
					<div id="elementor-template-library-my-favorites">
						...
						<label id="elementor-template-library-filter-my-favorites-label" for="elementor-template-library-filter-my-favorites">
							<i class="eicon" aria-hidden="true"></i>' . esc_html__( 'My Favorites', 'elementor' ) . '
						</label>
					</div>
				</div>
			<# } else { #>
			...
			<div id="elementor-template-library-filter-text-wrapper">
				<label for="elementor-template-library-filter-text" class="elementor-screen-only">' . esc_html__( 'Search Templates:', 'elementor' ) . '</label>
				<input id="elementor-template-library-filter-text" placeholder="' . esc_attr__( 'Search', 'elementor' ) . '">
		...
		<# if ( \'local\' === activeSource ) { #>
			<div id="elementor-template-library-order-toolbar-local">
				<div class="elementor-template-library-local-column-1">
					...
					<label for="elementor-template-library-order-local-title" class="elementor-template-library-order-label">' . esc_html__( 'Name', 'elementor' ) . '</label>
				</div>
				<div class="elementor-template-library-local-column-2">
					...
					<label for="elementor-template-library-order-local-type" class="elementor-template-library-order-label">' . esc_html__( 'Type', 'elementor' ) . '</label>
				</div>
				<div class="elementor-template-library-local-column-3">
					...
					<label for="elementor-template-library-order-local-author" class="elementor-template-library-order-label">' . esc_html__( 'Created By', 'elementor' ) . '</label>
				</div>
				<div class="elementor-template-library-local-column-4">
					...
					<label for="elementor-template-library-order-local-date" class="elementor-template-library-order-label">' . esc_html__( 'Creation Date', 'elementor' ) . '</label>
				</div>
				<div class="elementor-template-library-local-column-5">
					<div class="elementor-template-library-order-label">' . esc_html__( 'Actions', 'elementor' ) . '</div>
				</div>
			</div>
		<# } #>
		...
		<# if ( \'remote\' === activeSource ) { #>
			<div id="elementor-template-library-footer-banner">
				...
				<div class="elementor-excerpt">' . esc_html__( 'Stay tuned! More awesome templates coming real soon.', 'elementor' ) . '</div>
			</div>
		<# } #>
	',
	'tmpl-elementor-template-library-template-remote' => '
		...
		<div class="elementor-template-library-template-footer">
			...
			<div class="elementor-template-library-favorite">
				...
				<label for="elementor-template-library-template-{{ template_id }}-favorite-input" class="elementor-template-library-template-favorite-label">
					...
					<span class="elementor-screen-only">' . esc_html__( 'Favorite', 'elementor' ) . '</span>
				</label>
			</div>
		</div>
	',
	'tmpl-elementor-template-library-template-local' => '
		...
		<div class="elementor-template-library-template-controls elementor-template-library-local-column-5">
			<div class="elementor-template-library-template-preview elementor-button e-btn-txt">
				...
				<span class="elementor-template-library-template-control-title">' . esc_html__( 'Preview', 'elementor' ) . '</span>
			</div>
			<button class="elementor-template-library-template-action elementor-template-library-template-insert elementor-button e-primary e-btn-txt">
				...
				<span class="elementor-button-title">' . esc_html__( 'Insert', 'elementor' ) . '</span>
			</button>
			<div class="elementor-template-library-template-more-toggle">
				<i class="eicon-ellipsis-h" aria-hidden="true"></i>
				<span class="elementor-screen-only">' . esc_html__( 'More actions', 'elementor' ) . '</span>
			</div>
			<div class="elementor-template-library-template-more">
				<div class="elementor-template-library-template-delete">
					<i class="eicon-trash-o" aria-hidden="true"></i>
					<span class="elementor-template-library-template-control-title">' . esc_html__( 'Delete', 'elementor' ) . '</span>
				</div>
				<div class="elementor-template-library-template-export">
					<a href="{{ export_link }}">
						<i class="eicon-sign-out" aria-hidden="true"></i>
						<span class="elementor-template-library-template-control-title">' . esc_html__( 'Export', 'elementor' ) . '</span>
					</a>
				</div>
			</div>
		</div>
	',
	'tmpl-elementor-template-library-insert-button' => '
	...
	'tmpl-elementor-template-library-apply-ai-button' => '
		<a class="elementor-template-library-template-action elementor-template-library-template-apply-ai elementor-button e-primary">
			<i class="eicon-file-download" aria-hidden="true"></i>
			<span class="elementor-button-title">' . esc_html__( 'Apply', 'elementor' ) . '</span>
		</a>
	',
	'tmpl-elementor-template-library-insert-and-ai-variations-buttons' => '
		<a class="elementor-template-library-template-action elementor-template-library-template-insert elementor-button e-primary">
			<i class="eicon-file-download" aria-hidden="true"></i>
			<span class="elementor-button-title">' . esc_html__( 'Insert', 'elementor' ) . '</span>
		</a>
		<a class="elementor-template-library-template-action elementor-template-library-template-generate-variation elementor-button e-btn-txt e-btn-txt-border">
			...
			<span class="elementor-button-title">' . esc_html__( 'Generate Variations', 'elementor' ) . '</span>
		</a>
	',
	...
	',
	'tmpl-elementor-template-library-save-template' => '
		...
		<form id="elementor-template-library-save-template-form">
			...
			<input id="elementor-template-library-save-template-name" name="title" placeholder="' . esc_attr__('Enter Template Name', 'elementor') . '" required>
			<button id="elementor-template-library-save-template-submit" class="elementor-button e-primary">
				<span class="elementor-state-icon">
					<i class="eicon-loading eicon-animation-spin" aria-hidden="true"></i>
				</span>
				' . esc_html__('Save', 'elementor') . '
			</button>
		</form>
		<div class="elementor-template-library-blank-footer">
			' . esc_html__('Want to learn more about the Elementor library?', 'elementor') . '
			<a class="elementor-template-library-blank-footer-link" href="https://go.elementor.com/docs-library/" target="_blank">' . esc_html__('Click here', 'elementor') . '</a>
		</div>
	',
	'tmpl-elementor-template-library-import' => '
		<form id="elementor-template-library-import-form">
			<div class="elementor-template-library-blank-icon">
				<i class="eicon-library-upload" aria-hidden="true"></i>
			</div>
			<div class="elementor-template-library-blank-title">' . esc_html__('Import Template to Your Library', 'elementor') . '</div>
			<div class="elementor-template-library-blank-message">' . esc_html__('Drag & drop your .JSON or .zip template file', 'elementor') . '</div>
			<div id="elementor-template-library-import-form-or">' . esc_html__('or', 'elementor') . '</div>
			<label for="elementor-template-library-import-form-input" id="elementor-template-library-import-form-label" class="elementor-button e-primary">' . esc_html__('Select File', 'elementor') . '</label>
	...
	',
	'tmpl-elementor-template-library-templates-empty' => '
		<div class="elementor-template-library-blank-icon">
			<img src="' . esc_url (ELEMENTOR_ASSETS_URL . 'images/no-search-results.svg' ) . '" class="elementor-template-library-no-results" loading="lazy" />
		</div>
	...
	',
	'tmpl-elementor-template-library-preview' => '
		<iframe></iframe>
	',
	'tmpl-elementor-template-library-connect' => '
		...
		<a id="elementor-template-library-connect__button" class="elementor-button e-primary" href="{{{ url }}}">
			{{{ button }}}
		</a>
		<img id="elementor-template-library-connect__background-image-left-1" class="elementor-template-library-connect__background-image" src="{{{ baseImagesUrl }}}left-1.png" draggable="false" loading="lazy" />
		<img id="elementor-template-library-connect__background-image-left-2" class="elementor-template-library-connect__background-image" src="{{{ baseImagesUrl }}}left-2.png" draggable="false" loading="lazy" />
		<img id="elementor-template-library-connect__background-image-right-1" class="elementor-template-library-connect__background-image" src="{{{ baseImagesUrl }}}right-1.png" draggable="false" loading="lazy" />
		<img id="elementor-template-library-connect__background-image-right-2" class="elementor-template-library-connect__background-image" src="{{{ baseImagesUrl }}}right-2.png" draggable="false" loading="lazy" />
	',
];
