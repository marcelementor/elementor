...
$script_templates = [
	...
	'tmpl-elementor-panel-footer-content' => '
		<button id="elementor-panel-footer-settings" class="elementor-panel-footer-tool elementor-leave-open tooltip-target" data-tooltip="' . esc_attr__( "Settings", "elementor" ) . '">
			<i class="eicon-cog" aria-hidden="true"></i>
			<span class="elementor-screen-only">' . sprintf( esc_html__( "%s Settings", "elementor" ), esc_html( $document::get_title() ) ) . '</span>
		</button>
		<# if ( $e.components.get( "document/elements" ).utils.showNavigator() ) { #>
		<button id="elementor-panel-footer-navigator" class="elementor-panel-footer-tool tooltip-target" data-tooltip="' . ( $is_app_bar_active ? esc_attr__( "Structure", "elementor" ) : esc_attr__( "Navigator", "elementor" ) ) . '">
			<i class="eicon-navigator" aria-hidden="true"></i>
			<span class="elementor-screen-only">' . ( $is_app_bar_active ? esc_html__( "Structure", "elementor" ) : esc_html__( "Navigator", "elementor" ) ) . '</span>
		</button>
		<# } #>
		<button id="elementor-panel-footer-history" class="elementor-panel-footer-tool elementor-leave-open tooltip-target" data-tooltip="' . esc_attr__( "History", "elementor" ) . '">
			<i class="eicon-history" aria-hidden="true"></i>
			<span class="elementor-screen-only">' . esc_html__( "History", "elementor" ) . '</span>
		</button>
		<button id="elementor-panel-footer-responsive" class="elementor-panel-footer-tool elementor-toggle-state tooltip-target" data-tooltip="' . esc_attr__( "Responsive Mode", "elementor" ) . '">
			<i class="eicon-device-responsive" aria-hidden="true"></i>
			<span class="elementor-screen-only">' . esc_html__( "Responsive Mode", "elementor" ) . '</span>
		</button>
		<button id="elementor-panel-footer-saver-preview" class="elementor-panel-footer-tool tooltip-target" data-tooltip="' . esc_attr__( "Preview Changes", "elementor" ) . '">
			<span id="elementor-panel-footer-saver-preview-label">
				<i class="eicon-preview-medium" aria-hidden="true"></i>
				<span class="elementor-screen-only">' . esc_html__( "Preview Changes", "elementor" ) . '</span>
			</span>
		</button>
		<div id="elementor-panel-footer-saver-publish" class="elementor-panel-footer-tool">
			...
			<button id="elementor-panel-saver-button-publish" class="elementor-button e-primary elementor-disabled" title="{{{ publishTitle }}}">
				...
				<span id="elementor-panel-saver-button-publish-label">' . esc_html__( "Publish", "elementor" ) . '</span>
			</button>
		</div>
		<div id="elementor-panel-footer-saver-options" class="elementor-panel-footer-tool elementor-toggle-state">
			<button id="elementor-panel-saver-button-save-options" class="elementor-button e-primary tooltip-target elementor-disabled" data-tooltip="' . esc_attr__( "Save Options", "elementor" ) . '" data-tooltip-offset="7">
				<i class="eicon-chevron-right" aria-hidden="true"></i>
				<span class="elementor-screen-only">' . esc_html__( "Save Options", "elementor" ) . '</span>
			</button>
			<div class="elementor-panel-footer-sub-menu-wrapper">
				...
				<div class="elementor-panel-footer-sub-menu">
					<div id="elementor-panel-footer-sub-menu-item-save-draft" class="elementor-panel-footer-sub-menu-item elementor-disabled">
						...
						<span class="elementor-title">' . esc_html__( "Save Draft", "elementor" ) . '</span>
					</div>
					<div id="elementor-panel-footer-sub-menu-item-save-template" class="elementor-panel-footer-sub-menu-item">
						...
						<span class="elementor-title">' . esc_html__( "Save as Template", "elementor" ) . '</span>
					</div>
					...
					<div id="elementor-panel-footer-sub-menu-item-copy-share-link" class="elementor-panel-footer-sub-menu-item">
						...
						<span class="elementor-title">' . esc_html__( "Copy and Share Link", "elementor" ) . '</span>
					</div>
					<# } #>
				</div>
			</div>
	...
	',
	'tmpl-elementor-mode-switcher-content' => '
		<label for="elementor-mode-switcher-preview-input" id="elementor-mode-switcher-preview" title="' . esc_attr__( "Hide Panel", "elementor" ) . '">
			<i class="eicon" aria-hidden="true" tabindex="0"></i>
			<span class="elementor-screen-only">' . esc_html__( "Hide Panel", "elementor" ) . '</span>
		</label>
	...
	'tmpl-editor-content' => '
		...
		<# if ( elementData.reload_preview ) { #>
			<div class="elementor-update-preview">
				<div class="elementor-update-preview-title">' . esc_html__( "Update changes to page", "elementor" ) . '</div>
				<div class="elementor-update-preview-button-wrapper">
					<button class="elementor-update-preview-button elementor-button">' . esc_html__( "Apply", "elementor" ) . '</button>
				</div>
			</div>
		<# } #>
		...
		<# } #>
	',
	'tmpl-elementor-panel-schemes-disabled' => '
		...
		<div class="elementor-nerd-box-title">{{{ ' . esc_html__( '%s are disabled', 'elementor' ) . '.replace( \'%s\', disabledTitle ) }}}</div>
		<div class="elementor-nerd-box-message">' . sprintf(
			...
			<div class="elementor-control-responsive-switchers__holder">
				<#
					...
					_.each( devices, function( device ) {
						var deviceLabel = \'desktop\' === device ? \'' . esc_html__( 'Desktop', 'elementor' ) . '\' : activeBreakpoints[ device ].label,
							tooltipDir = "' . ( is_rtl() ? 'e' : 'w' ) . '";
					#>
	...
	',
	'tmpl-elementor-control-dynamic-switcher' => '
		<button class="elementor-control-dynamic-switcher elementor-control-unit-1" data-tooltip="' . esc_attr__( 'Dynamic Tags', 'elementor' ) . '">
			<i class="eicon-database" aria-hidden="true"></i>
			<span class="elementor-screen-only">' . esc_html__( 'Dynamic Tags', 'elementor' ) . '</span>
		</button>
	',
	'tmpl-elementor-control-element-color-picker' => '
		<button class="elementor-control-element-color-picker e-control-tool" data-tooltip="' . esc_attr__( 'Color Sampler', 'elementor' ) . '">
			<i class="eicon-eyedropper" aria-hidden="true"></i>
			<span class="elementor-screen-only">' . esc_html__( 'Color Sampler', 'elementor' ) . '</span>
		</button>
	',
	'tmpl-elementor-control-dynamic-cover' => '
	...
	'tmpl-elementor-dynamic-tags-promo' => '
		<div class="elementor-tags-list__teaser">
			<div class="elementor-tags-list__group-title elementor-tags-list__teaser-title">
				<i class="eicon-info-circle"></i>' . esc_html__( 'Elementor Dynamic Content', 'elementor' ) . '
			</div>
			<div class="elementor-tags-list__teaser-text">
				' . esc_html__( 'You’re missing out!', 'elementor' ) . '<br />
				' . esc_html__( 'Get more dynamic capabilities by incorporating dozens of Elementor\'s native dynamic tags.', 'elementor' ) . '
				<a href="{{{ promotionUrl }}}" class="elementor-tags-list__teaser-link" target="_blank">
					' . esc_html__( 'Upgrade', 'elementor' ) . '
				</a>
			</div>
		</div>
	',
...
<?php
$typography_item = ob_get_clean();

$script_templates['tmpl-elementor-panel-scheme-typography-item'] = $typography_item;
